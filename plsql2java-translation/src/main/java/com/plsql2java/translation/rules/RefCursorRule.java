...
@Component
public class RefCursorRule implements TranslationRule {

    @Override
    public ConstructType getConstructType() {
        return ConstructType.REF_CURSOR;
    }

    @Override
    public TranslationOutcome apply(AstNode node, TranslationContext context) {
        return TranslationOutcome.flagged(
                "REF CURSOR has no direct Java equivalent",
                "Replace REF CURSOR with Spring Data projection or DTO-based query method",
                50
        );
    }
}
